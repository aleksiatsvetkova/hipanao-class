        ...
        <div class="card tc-login-card">
          <div class="card-body login-card-body" style="padding:35px 30px;">
            ...
            <h2 class="text-center font-weight-bold" style="color:#A73A34;">
              <i class="fas fa-user-shield mr-1"></i>Admin / Staff Login
            </h2>
            <p class="text-center text-muted mb-1">Tañon College</p>
            <p class="text-center text-muted mb-4">Sign in with your username to continue</p>

            <form action="login.php?type=admin" method="post">

              <input type="hidden" name="logintype" value="admin">

              <div class="input-group mb-3">
                <input type="text" class="form-control tc-input" name="username" placeholder="Username"
                       value="<?php echo htmlspecialchars($username); ?>" required>
                <div class="input-group-append">
                  <div class="input-group-text tc-input-icon"><span class="fas fa-user"></span></div>
                </div>
              </div>
              ...
              <div class="row mb-3">
                <div class="col-8">
                  <div class="icheck-primary d-inline">
                    <input type="checkbox" id="remember" name="remember" <?php echo isset($_COOKIE['hipanao_admin_user']) ? "checked" : ""; ?>>
